package com.cam.pdf.and.doc.india.scanner.libary;

import android.graphics.Bitmap;

import com.cam.pdf.and.doc.india.scanner.util.ImageUtils;
import com.cam.pdf.and.doc.india.scanner.util.MathUtils;
...
public class NativeClass {
    ...
    //    public List<Point> getPointFromBitMap(float[] points){
//        float x1 = points[0];
//        float x2 = points[1];
//        float x3 = points[2];
//        float x4 = points[3];
...
//        pointFs.add(new Point(x1, y1));
//        pointFs.add(new Point(x2, y2));
//        pointFs.add(new Point(x3, y3));
//        pointFs.add(new Point(x4, y4));
//        return pointFs;
//    }
